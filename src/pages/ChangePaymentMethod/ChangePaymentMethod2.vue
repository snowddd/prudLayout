...
<template>
  ...
  >
    ...
    <el-row style="margin-top:1.5rem">
      <el-col :span="12">請選取變更後的繳費方式：</el-col>
      <el-col :span="12" style="text-align:left">
        <el-radio v-model="paymentMethod" label="1">自行繳納</el-radio>
      </el-col>
    </el-row>
    <el-row style="margin-top:1.5rem">
      <el-col :span="12">請選取變更後的繳費方式：</el-col>
      <el-col :span="12" style="text-align:left">
        <el-radio v-model="paymentMethod" label="2">恢復原帳戶扣款</el-radio>
      </el-col>
    </el-row>
    <el-row style="margin-top:1.5rem">
      <el-col :span="8">
  ...
  methods: {
    ...
    submitChange() {
      this.setPaymentMethod(this.paymentMethod)
        .then(() => {
          // console.log(res);
          this.$router.push("changePaymentMethod3");
        })
        .catch(() => {
          // console.log(err);
        });
